    ...
    return (
        <div className="text-center mx-10 md:mx-auto lg:mx-auto">
            ...
            <div data-aos="fade-up" data-aos-duration="3000" className='grid  grid-cols-1 md:grid-cols-2 gap-6 mb-16'>
                    ...
                    <div key={country._id} className="grid grid-cols-1 md:grid-cols-2 items-end bg-base-100 shadow-xl p-4 bg-gradient-to-b from-green-50 to-white">
                        <div className='w-full'>
                            <figure  className=''><img className=' w-[400px] rounded-2xl h-[300px]' src={country.photo} /></figure>
                        </div>
